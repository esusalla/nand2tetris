...
const std::unordered_map<std::string, std::string> Code::dest_{
    {"", "000"}, {"M", "001"}, {"D", "010"}, {"MD", "011"}, {"A", "100"}, {"AM", "101"}, {"AD", "110"}, {"AMD", "111"}};

const std::unordered_map<std::string, std::string> Code::comp_{
...
const std::unordered_map<std::string, std::string> Code::jump_{{"", "000"},    {"JGT", "001"}, {"JEQ", "010"},
